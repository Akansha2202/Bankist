...
//Experminting with API
// const now = new Date();
// const options = {
//   hour: 'numeric',
//   minute: 'numeric',
//   day: 'numeric',
//   month: 'long', //long 2-digit or numeric;
//   year: 'numeric',
// };

// //getting local from user browser
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    //DATE USING INTERNATIONLIZATION API;
...
btnLoan.addEventListener('click', function (e) {
  ...
  //Matgh.trunc to remove the decimal from requested loan
...
console.log(Number.parseInt('px1010', 10));
...
console.log(new Date('Aug 04 2020 18:09:34'));
console.log(new Date(account1.movementsDates[0]));

console.log(new Date(0));
console.log(new Date(0 * 24 * 60 * 60 * 1000));
...
/*
const future = new Date(2037, 10, 19, 15, 23, 7);
console.log(future);
console.log(future.getFullYear());
console.log(future.getMonth());
console.log(future.toISOString());
console.log(future.getTime());
console.log(new Date(2142237187000));
*/
/*
...
const days1 = calcDaysPassed(new Date(2037, 3, 10), new Date(2037, 3, 1));
console.log(days1);

const num = 38888467.23;
...
const indgredients = ['olives', 'spinach'];*/

// const pizzaTimer = setTimeout(
//   (ing1, ing2) => {
//     if (indgredients.includes('spinach')) {
//       //to clear a timeout
